...
let Bot = function() {
    ...
    this.onConnectedHandler = (addr, port) => {
        ...
        setTimeout(() =>
        setInterval(() => points.timedMessage('If the Egg overlord makes you giggle, capture this magic in the form of a clip. Give it a humorous title and go into the running for the monthly sub giveaway!'), 1000*60*60)
        , 1000*60*30)
