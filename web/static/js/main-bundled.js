  ...
  _createClass(OnlineUsersHandler, [{
    ...
    value: function getOnlineUsers() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/online-users").then(function (users) {
        ...
        var table = document.querySelector(".user-table>table>thead");
        table.innerHTML = "\n            <tr class='th'>\n                <td>User ID</td>\n                <td>Name</td>\n                <td>Points</td>\n            </tr>\n            ";
